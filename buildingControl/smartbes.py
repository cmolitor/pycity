...
class SmartBes(Bes):  # subclass inherits from class Bes
    def __init__(self, stepSize, TER1, TER2, RSC, sizingMethod, iApartments, sqm, specDemandTh, env=None, solPoolAbsGap=2, solPoolRelGap=0.2, solPoolIntensity=4):
        """
        ...
        super(SmartBes, self).__init__(stepSize, TER1, TER2, RSC, sizingMethod, iApartments, sqm, specDemandTh, env)
