...
class Bes(Building):  # subclass inherits from class Building
    def __init__(self, stepSize, TER1, TER2, RSC, sizingMethod, iApartments, sqm, specDemandTh, envrnmt=None):
        """
        ...
        EH:     +               -               -
        """
        super(Bes, self).__init__(iApartments, sqm, specDemandTh, stepSize)
