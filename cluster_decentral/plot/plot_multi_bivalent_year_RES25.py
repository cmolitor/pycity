...
resultfile = '../results/RMOPT_SD365_RES25_bivalent_step900_dynCOP_T2015-03-14_13-58-52/results_log.txt'
...
plt.grid(True)
plt.subplots_adjust(hspace=0.5, wspace=0.5, left=0.1, right=0.99, bottom=0.15, top=0.97)
#mytext = r'\small{average RPTV}'
plt.text(90, 0.1, 'average RPTV: {0:.4f}'.format(avg_RPTV), fontsize=10)
plt.text(240, 0.1, 'standard deviation: {0:.4f}'.format(stddev), fontsize=10, color='r')
fig.set_size_inches(6.2, 3.0)
plt.savefig("fig_multi_bivalent_year_25RES", dpi=300)